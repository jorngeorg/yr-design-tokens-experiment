...
function colorOverride(palette, options = {}) {
  ...
  return {
    ...
    "surface-tinted":         { light: v(palette, "50"),  dark: v(palette, "800") },
    "surface-hover":          { light: v(palette, "200"), dark: v(palette, "700") },
    "surface-active":         { light: v(palette, "300"), dark: v(palette, "600") },
